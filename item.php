...
$pdo = dbConnect();
// $results = $pdo->query("SELECT * FROM Items WHERE id=$itemID");
      ...
      <div class="card" data-itemid="<?php echo $id; ?>" id="item-card" data-itemname="<?php echo $name; ?>">
               ...
               <div class="float-right">
                  <div class="dropdown dropleft">
                     ...
                     <div class="dropdown-menu">
                        <div class="pointer dropdown-header" data-toggle="modal" data-target="#update-item-modal"><ion-icon name="create"></ion-icon> edit info</div>
                        <div class="dropdown-divider"></div>
                        <div onclick="deleteItem(<?php echo $itemID; ?>)" class="pointer dropdown-header"><ion-icon name="trash"></ion-icon> delete item</div>
                        <div class="dropdown-header pointer" data-toggle="modal" data-target="#addTodoListModal"><ion-icon name="add-circle"></ion-icon> add to list</div>
                     </div>
                  </div>
               </div>
            </h4>
         ...
         <div class="card-footer custom-bg-white">
           <div class="float-right">
            <?php
            if ($completed == 'n')
               echo "<a href=\"completed-item.php?itemID=$itemID\"><button class=\"btn btn-primary\">Mark complete</button></a>";
            else
               echo "<a href=\"uncomplete-item.php?itemID=$itemID\"><button class=\"btn btn-secondary\">Mark incomplete</button></a>";
            ?>
         </div>
