...
function getClassItemCounts($classID) {
  $pdo = dbConnect();
  $sql = $pdo->prepare('SELECT (select count(*) from Items where class_id=:classID) as total, (select count(*) from Items where class_id=:classID and completed="n") as open, (select count(*) from Items where class_id=:classID and completed="y") as completed, (select count(*) from Items where class_id=:classID and type="assignment") as assignments, (select count(*) from Items where class_id=:classID and completed="n" and type="assignment") as assignments_open, (select count(*) from Items where class_id=:classID and completed="y" and type="assignment") as assignments_completed, (select count(*) from Items where class_id=:classID and type="exam") as exams, (select count(*) from Items where class_id=:classID and completed="n" and type="exam") as exams_open, (select count(*) from Items where class_id=:classID and completed="y" and type="exam") as exams_completed, (select count(*) from Items where class_id=:classID and type="quiz") as quizzes, (SELECT COUNT(*) FROM Items WHERE class_id=:classID and completed="n" and type="quiz") as quizzes_open, (select count(*) from Items WHERE class_id=:classID and type="quiz" and completed="y") as quizzes_completed, (select count(*) from Items where class_id=:classID and type="project") as projects, (select count(*) from Items where class_id=:classID and type="project" and completed="n") as projects_open, (select count(*) from Items where class_id=:classID and type="project" and completed="y") as projects_completed, (select count(*) from Items where class_id=:classID and type="other") as other, (select count(*) from Items where class_id=:classID and type="other" and completed="n") as other_open, (select count(*) from Items where class_id=:classID and type="other" and completed="y") as other_completed');
